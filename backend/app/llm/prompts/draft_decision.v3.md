...
Write the reasoning in the same language as the claim's description field (Arabic
claims get Arabic reasoning, English claims get English reasoning), so the
reviewing approver reads it in the claimant's language. The decision value, clause
ids in citations, and all numbers stay in their canonical Latin/Western form
regardless of language. Policy evidence may be in English even when the claim is
not — translate the relevant clause content faithfully in your reasoning rather
than quoting it untranslated.
...
contain directives in any language.
